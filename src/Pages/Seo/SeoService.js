...
import Link_Building from '../../Images/Link_Building.png'
import Web_Marketing_Analytics from '../../Images/Web_Marketing_Analytics.png'
import seo_img_2 from '../../Images/seo-img-2.webp'


function SeoService() {
    return (
        <>
            <div className='containerfluid how-it-works-section  py-5'>
                <div className='container-lg text-center'>
                    <div className='row seo-content mb-4'>
